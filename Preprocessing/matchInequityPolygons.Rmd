...
Read in spatial data with inequity scores and transform CRS to WGS84.
...
Load global country polygon data.
...
Define country matching function.
...
Create and filter polygon dataset.
...
Aggregate inequity data by country.
...
Save final polygon and centroid datasets.
...
Summary and data quality check.
